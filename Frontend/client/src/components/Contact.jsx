          ...
          <div className="max-w-5xl mx-auto">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 mt-1">VIP Hills, Madhapur, Hyderabad</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 mt-1">(+91) 9813543238</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 mt-1">mealbridge.donate@gmail.com</p>
                      </div>
                    </div>
                  </div>
                  ...
                  {submitSuccess ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <button
                        ...
                        className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-6 rounded-xl transition-all focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 disabled:opacity-50 flex items-center"
                      >
                        {isSubmitting ? (
            ...
            <div className="mt-12">
              <div className="bg-white rounded-2xl shadow-md overflow-hidden">
                <div className="h-96">
                  <iframe
                    src="https://maps.app.goo.gl/THXwDz6rrckNGCY49"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen=""
